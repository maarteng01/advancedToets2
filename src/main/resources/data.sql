...
insert into SNACK (ID, NAME, VEGAN, SIDE_DISH_POSSIBLE, PRICE, PRI
    CE_SIDE_DISH) values(1,'Hamburger', false, true, 8.5, 3.5);
insert into SNACK (ID, NAME, VEGAN, SIDE_DISH_POSSIBLE, PRICE) val
    ues(2,'Pizza', false, false, 12);
insert into SNACK (ID, NAME, VEGAN, SIDE_DISH_POSSIBLE, PRICE, PRI
    CE_SIDE_DISH) values(3,'Croque Monsieur', false, true, 6.5, 3.5);
insert into SNACK (ID, NAME, VEGAN, SIDE_DISH_POSSIBLE, PRICE) val
    ues(4,'Tajin Chicken', false, false, 14);
insert into SNACK (ID, NAME, VEGAN, SIDE_DISH_POSSIBLE, PRICE) val
    ues(5,'Tajin Vegan', true, false, 15.5);
insert into SNACK (ID, NAME, VEGAN, SIDE_DISH_POSSIBLE, PRICE, PRI
    CE_SIDE_DISH) values(6,'Salmon Wraps', false, true, 11, 4.5);
insert into SNACK (ID, NAME, VEGAN, SIDE_DISH_POSSIBLE, PRICE, PRI
    CE_SIDE_DISH) values(7,'Vegan Wraps', true, true, 10.5, 4.5);
